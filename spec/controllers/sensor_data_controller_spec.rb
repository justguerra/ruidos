...
RSpec.describe SensorDataController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all sensor_data as @sensor_data" do
      ...
      expect(assigns(:sensor_data)).to eq([sensor_datum])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested sensor_datum as @sensor_datum" do
      ...
      expect(assigns(:sensor_datum)).to eq(sensor_datum)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new sensor_datum as @sensor_datum" do
      ...
      expect(assigns(:sensor_datum)).to be_a_new(SensorDatum)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created sensor_datum as @sensor_datum" do
        post :create, {:sensor_datum => valid_attributes}, valid_session
        expect(assigns(:sensor_datum)).to be_a(SensorDatum)
        expect(assigns(:sensor_datum)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved sensor_datum as @sensor_datum" do
        post :create, {:sensor_datum => invalid_attributes}, valid_session
        expect(assigns(:sensor_datum)).to be_a_new(SensorDatum)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested sensor_datum" do
        sensor_datum = SensorDatum.create! valid_attributes
        put :update, {:id => sensor_datum.to_param, :sensor_datum => new_attributes}, valid_session
        sensor_datum.reload
      ...
      it "redirects to the sensor_datum" do
        sensor_datum = SensorDatum.create! valid_attributes
        put :update, {:id => sensor_datum.to_param, :sensor_datum => valid_attributes}, valid_session
        expect(response).to redirect_to(sensor_datum)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the sensor_datum as @sensor_datum" do
        sensor_datum = SensorDatum.create! valid_attributes
        put :update, {:id => sensor_datum.to_param, :sensor_datum => invalid_attributes}, valid_session
        expect(assigns(:sensor_datum)).to eq(sensor_datum)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the sensor_data list" do
      sensor_datum = SensorDatum.create! valid_attributes
      delete :destroy, {:id => sensor_datum.to_param}, valid_session
      expect(response).to redirect_to(sensor_data_url)
    end
  end
